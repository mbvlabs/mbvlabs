...
```go
import "mbvlabs/models/internal/db"
...
MAILPIT_PORT=1025
DEFAULT_SENDER_SIGNATURE=info@mbvlabs.com
...
# Telemetry (optional)
TELEMETRY_SERVICE_NAME=mbvlabs
