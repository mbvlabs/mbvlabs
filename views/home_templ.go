...
func Home() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var7 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 9, "\" class=\"btn px-8 py-3 text-foreground\">See more</a></div></div><div class=\"grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-6 px-4 pb-12\"><span class=\"col-span-full\"><p class=\"text-lg font-bold text-foreground\">Some of my clients</p></span> <img class=\"h-24\" src=\"https://media.mbvlabs.com/clients/yld-logo.svg\" alt=\"Company Logo of YLD\"> <img class=\"h-24\" src=\"https://media.mbvlabs.com/clients/everphone-gmbh-logo.jpeg\" alt=\"Company Logo of everphone\"> <img class=\"h-24 border border-black\" src=\"https://media.mbvlabs.com/clients/kuatro-group-logo.jpeg\" alt=\"Company Logo of kuatro group\"></div></div><div class=\"bg-black py-16 mt-20\"><div class=\"container flex flex-col mx-auto items-center gap-6 md:w-2/3 text-white\"><h2 class=\"text-2xl font-bold\">Development Philosophy</h2><div class=\"grid grid-cols-1 md:grid-cols-3\"><p class=\"col-start-1 col-end-2\"><span class=\"font-bold\">Hypothesis-driven</span> software development aims to be less wrong, not more right. Given ever-changing business environments software needs to change fast and in the right direction. In close collaboration with your team, we ensure all relevant options are covered, so we go down the right path.</p></div><div class=\"grid grid-cols-1 md:grid-cols-3\"><p class=\"col-start-3 col-end-4\"><span class=\"font-bold\">Remote first </span> allows people to work from where they're most productive. However, it also requires you to be a strong communicator and when done right, creates a natural self-documenting engineering environment. Here at mbvlabs, I've worked remotely since before Covid and can comfortably help you, no matter your timezone.</p></div><div class=\"grid grid-cols-1 md:grid-cols-3\"><p class=\"col-start-1 col-end-2\"><span class=\"font-bold\">Iterate</span> and do it fast. Software is never right the first time and often requires multiple rounds of iteration to get just right. I'm an expert in testing out hypotheses in the real world, having done so in multiple industries, learning and adjusting software to the results.</p></div><div class=\"grid grid-cols-1 md:grid-cols-3\"><p class=\"col-start-3 col-end-4\"><span class=\"font-bold\">Finished software</span> is hard to achieve but is still the aim of how I work. I leave my clients with software they can continue working on after our services are no longer needed. I aim to get you from A to B, providing you with the tools you need to continue from B on your own.</p></div></div></div><div class=\"container mx-auto my-20 flex justify-center\"><button class=\"cursor-pointer font-bold text-2xl text-center\" data-cal-link=\"mbvlabs/quick-intro\" data-cal-namespace=\"quick-intro\" data-cal-config='{\"layout\":\"month_view\"}'>Interested? Let's talk.</button><!-- Cal element-click embed code begins --><script type=\"text/javascript\">\n  (function (C, A, L) { let p = function (a, ar) { a.q.push(ar); }; let d = C.document; C.Cal = C.Cal || function () { let cal = C.Cal; let ar = arguments; if (!cal.loaded) { cal.ns = {}; cal.q = cal.q || []; d.head.appendChild(d.createElement(\"script\")).src = A; cal.loaded = true; } if (ar[0] === L) { const api = function () { p(api, arguments); }; const namespace = ar[1]; api.q = api.q || []; if(typeof namespace === \"string\"){cal.ns[namespace] = cal.ns[namespace] || api;p(cal.ns[namespace], ar);p(cal, [\"initNamespace\", namespace]);} else p(cal, ar); return;} p(cal, ar); }; })(window, \"https://app.cal.com/embed/embed.js\", \"init\");\nCal(\"init\", \"quick-intro\", {origin:\"https://app.cal.com\"});\n\n  \n  // Important: Please add the following attributes to the element that should trigger the calendar to open upon clicking.\n\n  Cal.ns[\"quick-intro\"](\"ui\", {\"hideEventTypeDetails\":false,\"layout\":\"month_view\"});\n  </script><!-- Cal element-click embed code ends --></div></main>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			return nil
